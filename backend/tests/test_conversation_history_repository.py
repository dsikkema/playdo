...
def test_save_new_empty_conversation(repository):
...
def test_get_conversation_empty(repository):
...
def test_get_conversation_not_found(repository):
...
def test_get_all_conversation_ids_empty(repository):
    """Test getting all conversation IDs when database is empty."""
    assert repository.get_all_conversation_ids() == []


def test_get_all_conversation_ids_with_data(repository):
...
def test_conversation_manager_cleanup(initialized_db):
    """
...
def test_message_sequence_ordering(repository):
...
def test_conversation_timestamps(repository):
